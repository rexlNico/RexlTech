...
import de.rexlnico.rexltech.screen.*;
...
public class RexlTech {
    ...
    private void setupClient(final FMLClientSetupEvent event) {
        ...
        ScreenManager.registerFactory(ContainerInit.SMELTER_CONTAINER.get(), SmelterScreen::new);
        ScreenManager.registerFactory(ContainerInit.MINER_CONTAINER.get(), MinerScreen::new);
